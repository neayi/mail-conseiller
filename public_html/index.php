...
<head>
  ...
  <title>Aglaé - Chambre d'Agriculture Occitanie</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a target="_blank" class="nav-link" href="https://tripleperformance.fr">Triple Performance</a>
          </li>
...
if (!empty($_GET['p']))
{
  ...
  foreach ($pratiques as $k => $p)
    $pratiques[$k]['url'] = $p['url'] . "?utm_source=aglae&utm_medium=e-mail&utm_campaign=" . urlencode($nom);

?>

<div class="my-5">
Votre mail est prêt ! Vous pouvez copier le texte ci-dessous et le coller dans votre outil de mail.
N'hésitez pas à le modifier et à l'adapter si nécessaire !
</div>
...
?>
    ...
    J'espère que tout va bien !<br><br>

    J'ai pensé à vous, car nous venons de finir la rédaction d'un nouveau retour d'expérience dans le cadre du programme Aglaé (avec la Chambre d'Agri Occitanie),
    qui pourrait vous intéresser.<br><br>
    ...
    En vous souhaitant une très bonne journée,<br><br>
...
<?php
    ...
    else
    {
      ...
      J'ai pensé à vous, car nous venons de finir la rédaction de nouveaux retours d'expérience dans le cadre du programme Aglaé (avec la Chambre d'Agri Occitanie),
      qui pourraient vous intéresser.<br><br>
...
?>
        ...
        <h1 class="mt-5">Préparation du mail pour les agriculteurs</h1>
        ...
        <b>Et choisir la ou les pratiques que vous souhaitez partager avec votre contact :</b>
<?php
...
?>
          ...
          <button type="submit" class="btn btn-primary prepareMailButton">Préparer le mail !</button>
